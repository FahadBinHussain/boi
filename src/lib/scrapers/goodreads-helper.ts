...
// Goodreads submodule was removed from this repo.
// Keep a safe fallback to avoid build-time resolution failures.
const scrapeGoodreads = async (_url: string) => {
  throw new Error('Goodreads scraper is currently unavailable.');
};
